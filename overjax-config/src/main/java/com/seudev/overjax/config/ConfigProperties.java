...
public class ConfigProperties {
    ...
    public static final String SECURITY_KEYCLOAK_DEPLOYMENT = "overjax.security.keycloak.deployment";
    public static final String SECURITY_KEYCLOAK_RESOURCES_ACCESS = "overjax.security.keycloak.resource.access";
