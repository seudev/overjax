...
import static com.seudev.overjax.config.ConfigProperties.META_MESSAGES_KEY;
...
public class ResponseBodyHandler implements ContainerResponseFilter {
    ...
    public static final String SKIP_RESPONSE_WRAPPER = "com.seudev.overjax.core.filter.ResponseBodyHandler.SKIP_RESPONSE_WRAPPER";
